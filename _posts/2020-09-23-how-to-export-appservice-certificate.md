...
本記事では、App Service 証明書をエクスポートし、Application Gateway で利用する手順を紹介しておりますが、
...
2. 以下のスクリプト全体をコピーし、PowerShellにペーストした後、Enterを押します。
...
3. 次に、作成した Export-AppServiceCertificate コマンドを実行します。
