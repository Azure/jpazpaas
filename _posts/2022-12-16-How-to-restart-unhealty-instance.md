...
同様の操作は[インスタンス]から行うことも可能となりました。

![image-ad74303c-94e4-4eec-bfae-d8bc3d281470.png]({{site.baseurl}}/media/2022/12/image-ad74303c-94e4-4eec-bfae-d8bc3d281470.png)
...
また Reboot Worker API は 1つの App Service Plan に対して 1時間に1回しか実行できません。

## 2025年12月追記

Linux 環境(Web Apps for Container含む)に限り、同様の操作は[インスタンス]から行うことも可能となりました。

![image-59833536-d9cf-4899-8650-17ec9b2791e4.png]({{site.baseurl}}/media/2022/12/image-59833536-d9cf-4899-8650-17ec9b2791e4.png)


以上、App Service 上でアプリケーションが不安定な状態になった際の応急処置についてご紹介させていただきました。


2025 年 12 月 11 日時点の内容となります。<br>
