...
AI Search サービス自体は ARM で設定を管理できるため、ARM テンプレートとパラメータを保持しておけば、ARM テンプレートとパラメータを利用して同様のリソースを作成できます。  
...
[Azure portal を使用してテンプレートをエクスポートする | 制限事項](https://learn.microsoft.com/ja-jp/azure/azure-resource-manager/templates/export-template-portal#limitations)
