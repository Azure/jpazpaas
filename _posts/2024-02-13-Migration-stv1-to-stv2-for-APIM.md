...
_API Management service stv2 platform deployment into /subscriptions/<subscription id>/resourcegroups/<resource group name>/providers/microsoft.network/virtualnetworks/<vnet name>/subnets/<subnet name> is not supported, as it already contains API Management service(s) with stv1 platform in it as suggested by presence of "/subscriptions/<subscription id>/resourceGroups/<resource group name>/providers/Microsoft.Network/virtualNetworks/<vnet name>/subnets/<subnet name>/resourceNavigationLinks/<Navigation Link Name>". Please select a different subnet and try again. Refer to https://aka.ms/apim-infrastructure for definition of stv1 vs stv2._
<br><br>
