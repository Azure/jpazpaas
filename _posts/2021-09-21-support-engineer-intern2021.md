...
テレワークを快適にするためには、チーム全員が発信しやすい仕組み・空気を作ることが必要です。私はインターンに参加するまでこのことに気が付いていなかったため、非常に勉強になりました。
また、自分から発信をすることも重要であると感じました。発信することは自分のためでもあり、他の方の発言のしやすさにも貢献することになります。
